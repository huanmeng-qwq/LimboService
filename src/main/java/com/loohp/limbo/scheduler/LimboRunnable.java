...
public abstract class LimboRunnable implements LimboTask {
    ...
    public LimboRunnable runTaskLater(LimboPlugin plugin, long delay, TimeUnit unit) {
        synchronized (this) {
            if (!registered) {
                taskId = Limbo.getInstance().getScheduler().runTaskLater(plugin, this, delay, unit);
                registered = true;
                return this;
            } else {
                throw new IllegalStateException("LimboRunnable already scheduled");
    ...
    public LimboRunnable runTaskLaterAsync(LimboPlugin plugin, long delay, TimeUnit unit) {
        synchronized (this) {
            if (!registered) {
                taskId = Limbo.getInstance().getScheduler().runTaskLaterAsync(plugin, this, delay, unit);
                registered = true;
                return this;
            } else {
                throw new IllegalStateException("LimboRunnable already scheduled");
    ...
    public LimboRunnable runTaskTimer(LimboPlugin plugin, long delay, long period, TimeUnit unit) {
        synchronized (this) {
            if (!registered) {
                taskId = Limbo.getInstance().getScheduler().runTaskTimer(plugin, this, delay, period, unit);
                registered = true;
                return this;
            } else {
                throw new IllegalStateException("LimboRunnable already scheduled");
    ...
    public LimboRunnable runTaskTimerAsync(LimboPlugin plugin, long delay, long period, TimeUnit unit) {
        synchronized (this) {
            if (!registered) {
                taskId = Limbo.getInstance().getScheduler().runTaskTimerAsync(plugin, this, delay, period, unit);
                registered = true;
                return this;
            } else {
                throw new IllegalStateException("LimboRunnable already scheduled");
